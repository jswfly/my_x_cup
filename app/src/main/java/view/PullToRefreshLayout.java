	...
	public void refreshFinish(int refreshResult)
	{
		...
		switch (refreshResult)
		{
			case SUCCEED:
				...
				refreshStateTextView.setTextColor(Color.BLACK);
			...
			default:
				...
				refreshStateTextView.setTextColor(Color.RED);
				refreshStateImageView
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		switch (refreshResult)
		{
			case SUCCEED:
				...
				loadStateTextView.setTextColor(Color.BLACK);
			...
			default:
				...
				loadStateTextView.setTextColor(Color.RED);
